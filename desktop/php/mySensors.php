  ...
  <div class="col-lg-2 col-md-3 col-sm-4">
    <div class="bs-sidebar">
      <ul id="ul_eqLogic" class="nav nav-list bs-sidenav">
        <?php
        if ($state == 1) {
          echo ' <a class="btn btn-success tooltips changeIncludeState" title="{{Inclure périphérique RF}}" data-state="0" style="width : 100%;margin-bottom : 5px;"><i class="fas fa-sign-in fa-rotate-90"></i> {{Arrêter inclusion}}</a>';
        } else {
          echo ' <a class="btn btn-default tooltips changeIncludeState" title="{{Inclure périphérique RF}}" data-state="1" style="width : 100%;margin-bottom : 5px;"><i class="fas fa-sign-in fa-rotate-90"></i> {{Mode inclusion}}</a>';
        }
        ?>
  ...
  <div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
    ...
    <div class="eqLogicThumbnailContainer">
      ...
      if ($state == 1) {
        ...
        echo '<center>';
        echo '<i class="icon jeedom2-bright4" style="font-size : 5em;color:#94ca02;"></i>';
        echo '</center>';
    ...
    <legend><i class="fas fa-table"></i>  {{Mes mySensors}}
    </legend>
    <?php
    if (count($eqLogics) == 0) {
